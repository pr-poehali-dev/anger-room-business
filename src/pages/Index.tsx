  ...
  const tariffs = [
    {
      ...
      price: '2 500₽',
      duration: '30 минут',
      items: ['15 тарелок', '10 бутылок', '5 предметов мебели', 'Защитная экипировка'],
      icon: 'Zap',
    ...
    },
    {
      ...
      price: '4 500₽',
      duration: '60 минут',
      items: ['30 тарелок', '20 бутылок', '10 предметов мебели', 'Защитная экипировка', 'Музыка на выбор'],
      icon: 'Flame',
    ...
    },
    {
      ...
      price: '7 500₽',
      duration: '90 минут',
      items: ['50 тарелок', '30 бутылок', '15 предметов мебели', 'Защитная экипировка', 'Музыка на выбор', 'Видеосъёмка'],
      icon: 'Bomb',
